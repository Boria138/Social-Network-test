(() => {
  ...
  // client/modules/mediasoup-call-client.src.js
  ...
  (function attachMediasoupCallClient(global) {
    ...
    function createController(options) {
      const state = {
        callId: null,
        consumedProducerIds: /* @__PURE__ */ new Set(),
        consumers: /* @__PURE__ */ new Map(),
        device: null,
        emitAck: createAckEmitter(options.socket),
        peerStreams: /* @__PURE__ */ new Map(),
      ...
      async function createTransport(direction) {
        ...
        const transport = direction === "send" ? state.device.createSendTransport(params) : state.device.createRecvTransport(params);
      ...
      async function start(callId, localStream) {
        ...
        state.device = new import_mediasoup_client.Device();
